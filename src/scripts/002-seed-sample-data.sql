...
INSERT INTO attendance (event_id, member_id, attended_date, event_type)
VALUES 
    (1, 1, '2024-12-01', 'Service'),
    (1, 2, '2024-12-01', 'Service'),
    (2, 1, '2024-12-03', 'Event'),
    (2, 2, '2024-12-03', 'Event');